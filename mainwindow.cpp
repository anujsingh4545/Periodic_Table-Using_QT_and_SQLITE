    ...
    , ui(new Ui::MainWindow)
{
           ...
           ui->weight->setAlignment(Qt::AlignCenter);
            ui->melting->setAlignment(Qt::AlignCenter);
             ui->boiling->setAlignment(Qt::AlignCenter);
              ...
              ui->link->setAlignment(Qt::AlignCenter);
    ...
    mydb.setDatabaseName("c:/sqlite/data.db");
    if(!mydb.open())
...
void MainWindow::fun(int val){
    ...
    ui->boiling->setText("");
    ui->link->setText("");
    QString name=" ",number=" ",electronic=" ",group=" ",period=" ",block=" ",weight=" ",radius=" ",melting=" ",boiling=" ",link=" ";
    int atomic = val;
...
{
    fun(1);
    ui->link->setText("<a href=\"https://www.youtube.com/watch?v=1uJk4K_irP8\">More About</a>");
